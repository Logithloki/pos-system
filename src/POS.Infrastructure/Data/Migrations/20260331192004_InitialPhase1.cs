        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRestoreOperation = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CumulativeSpend = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceType = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ResourceId = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    Status = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    CorrelationId = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ReceiptNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ...
                    OriginalSalesOrderId = table.Column<long>(type: "INTEGER", nullable: true),
                    TotalBeforeDiscount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    ...
                    TotalAfterTax = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    PaymentMethod = table.Column<int>(type: "INTEGER", nullable: false),
                    AmountTendered = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SalesOrders_SalesOrders_OriginalSalesOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiptNumber = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ThermalPayload = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineDiscountAmount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrintedUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedUtc = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReceiptPrintLogs_Receipts_ReceiptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceiptPrintLogs_ReceiptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_OriginalSalesOrderId",
                table: "SalesOrders",
                column: "OriginalSalesOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_ReceiptNumber",
                table: "SalesOrders",
                column: "ReceiptNumber",
                unique: true);
